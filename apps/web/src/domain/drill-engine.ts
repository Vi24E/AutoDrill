...
const FRACTION_INTEGER_MULTIPLICATION_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['21'];
const FRACTION_INTEGER_DIVISION_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['22'];
const FRACTION_SUMMARY_IMPROPER_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['23'];
const DECIMAL_DIVISION_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['24'];
const COLUMN_ADD_2DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['25'];
const COLUMN_SUBTRACT_2DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['26'];
const COLUMN_ADD_3_4DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['27'];
const COLUMN_SUBTRACT_3_4DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['28'];
const COLUMN_MULTIPLY_1DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['29'];
const COLUMN_MULTIPLY_2DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['30'];
const COLUMN_DIVIDE_1DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['31'];
const COLUMN_DIVIDE_2DIGIT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['32'];
const COLUMN_DECIMAL_ADD_SUBTRACT_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['33'];
const COLUMN_DECIMAL_MULTIPLY_INTEGER_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['34'];
const COLUMN_DECIMAL_DIVIDE_INTEGER_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['35'];
const COLUMN_DECIMAL_MULTIPLICATION_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['36'];
const COLUMN_DECIMAL_DIVISION_CORE_CONTRACT = DRILL_CORE_CONTRACT.themes['37'];
...
export const FRACTION_INTEGER_MULTIPLICATION_THEME_ID = FRACTION_INTEGER_MULTIPLICATION_CORE_CONTRACT.numeric_theme_id;
export const FRACTION_INTEGER_DIVISION_THEME_ID = FRACTION_INTEGER_DIVISION_CORE_CONTRACT.numeric_theme_id;
export const FRACTION_SUMMARY_IMPROPER_THEME_ID = FRACTION_SUMMARY_IMPROPER_CORE_CONTRACT.numeric_theme_id;
export const DECIMAL_DIVISION_THEME_ID = DECIMAL_DIVISION_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_ADD_2DIGIT_THEME_ID = COLUMN_ADD_2DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_SUBTRACT_2DIGIT_THEME_ID = COLUMN_SUBTRACT_2DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_ADD_3_4DIGIT_THEME_ID = COLUMN_ADD_3_4DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_SUBTRACT_3_4DIGIT_THEME_ID = COLUMN_SUBTRACT_3_4DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_MULTIPLY_1DIGIT_THEME_ID = COLUMN_MULTIPLY_1DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_MULTIPLY_2DIGIT_THEME_ID = COLUMN_MULTIPLY_2DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_DIVIDE_1DIGIT_THEME_ID = COLUMN_DIVIDE_1DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_DIVIDE_2DIGIT_THEME_ID = COLUMN_DIVIDE_2DIGIT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_DECIMAL_ADD_SUBTRACT_THEME_ID = COLUMN_DECIMAL_ADD_SUBTRACT_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_DECIMAL_MULTIPLY_INTEGER_THEME_ID = COLUMN_DECIMAL_MULTIPLY_INTEGER_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_DECIMAL_DIVIDE_INTEGER_THEME_ID = COLUMN_DECIMAL_DIVIDE_INTEGER_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_DECIMAL_MULTIPLICATION_THEME_ID = COLUMN_DECIMAL_MULTIPLICATION_CORE_CONTRACT.numeric_theme_id;
export const COLUMN_DECIMAL_DIVISION_THEME_ID = COLUMN_DECIMAL_DIVISION_CORE_CONTRACT.numeric_theme_id;
...
export const FRACTION_INTEGER_MULTIPLICATION_SKILL_ID = FRACTION_INTEGER_MULTIPLICATION_CORE_CONTRACT.skill_id;
export const FRACTION_INTEGER_MULTIPLICATION_GENERATOR_REVISION = FRACTION_INTEGER_MULTIPLICATION_CORE_CONTRACT.generator_revision;
export const FRACTION_INTEGER_DIVISION_SKILL_ID = FRACTION_INTEGER_DIVISION_CORE_CONTRACT.skill_id;
export const FRACTION_INTEGER_DIVISION_GENERATOR_REVISION = FRACTION_INTEGER_DIVISION_CORE_CONTRACT.generator_revision;
export const FRACTION_SUMMARY_IMPROPER_SKILL_ID = FRACTION_SUMMARY_IMPROPER_CORE_CONTRACT.skill_id;
export const FRACTION_SUMMARY_IMPROPER_GENERATOR_REVISION = FRACTION_SUMMARY_IMPROPER_CORE_CONTRACT.generator_revision;
export const DECIMAL_DIVISION_SKILL_ID = DECIMAL_DIVISION_CORE_CONTRACT.skill_id;
export const DECIMAL_DIVISION_GENERATOR_REVISION = DECIMAL_DIVISION_CORE_CONTRACT.generator_revision;
export const COLUMN_ADD_2DIGIT_SKILL_ID = COLUMN_ADD_2DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_ADD_2DIGIT_GENERATOR_REVISION = COLUMN_ADD_2DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_SUBTRACT_2DIGIT_SKILL_ID = COLUMN_SUBTRACT_2DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_SUBTRACT_2DIGIT_GENERATOR_REVISION = COLUMN_SUBTRACT_2DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_ADD_3_4DIGIT_SKILL_ID = COLUMN_ADD_3_4DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_ADD_3_4DIGIT_GENERATOR_REVISION = COLUMN_ADD_3_4DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_SUBTRACT_3_4DIGIT_SKILL_ID = COLUMN_SUBTRACT_3_4DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_SUBTRACT_3_4DIGIT_GENERATOR_REVISION = COLUMN_SUBTRACT_3_4DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_MULTIPLY_1DIGIT_SKILL_ID = COLUMN_MULTIPLY_1DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_MULTIPLY_1DIGIT_GENERATOR_REVISION = COLUMN_MULTIPLY_1DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_MULTIPLY_2DIGIT_SKILL_ID = COLUMN_MULTIPLY_2DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_MULTIPLY_2DIGIT_GENERATOR_REVISION = COLUMN_MULTIPLY_2DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_DIVIDE_1DIGIT_SKILL_ID = COLUMN_DIVIDE_1DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_DIVIDE_1DIGIT_GENERATOR_REVISION = COLUMN_DIVIDE_1DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_DIVIDE_2DIGIT_SKILL_ID = COLUMN_DIVIDE_2DIGIT_CORE_CONTRACT.skill_id;
export const COLUMN_DIVIDE_2DIGIT_GENERATOR_REVISION = COLUMN_DIVIDE_2DIGIT_CORE_CONTRACT.generator_revision;
export const COLUMN_DECIMAL_ADD_SUBTRACT_SKILL_ID = COLUMN_DECIMAL_ADD_SUBTRACT_CORE_CONTRACT.skill_id;
export const COLUMN_DECIMAL_ADD_SUBTRACT_GENERATOR_REVISION = COLUMN_DECIMAL_ADD_SUBTRACT_CORE_CONTRACT.generator_revision;
export const COLUMN_DECIMAL_MULTIPLY_INTEGER_SKILL_ID = COLUMN_DECIMAL_MULTIPLY_INTEGER_CORE_CONTRACT.skill_id;
export const COLUMN_DECIMAL_MULTIPLY_INTEGER_GENERATOR_REVISION = COLUMN_DECIMAL_MULTIPLY_INTEGER_CORE_CONTRACT.generator_revision;
export const COLUMN_DECIMAL_DIVIDE_INTEGER_SKILL_ID = COLUMN_DECIMAL_DIVIDE_INTEGER_CORE_CONTRACT.skill_id;
export const COLUMN_DECIMAL_DIVIDE_INTEGER_GENERATOR_REVISION = COLUMN_DECIMAL_DIVIDE_INTEGER_CORE_CONTRACT.generator_revision;
export const COLUMN_DECIMAL_MULTIPLICATION_SKILL_ID = COLUMN_DECIMAL_MULTIPLICATION_CORE_CONTRACT.skill_id;
export const COLUMN_DECIMAL_MULTIPLICATION_GENERATOR_REVISION = COLUMN_DECIMAL_MULTIPLICATION_CORE_CONTRACT.generator_revision;
export const COLUMN_DECIMAL_DIVISION_SKILL_ID = COLUMN_DECIMAL_DIVISION_CORE_CONTRACT.skill_id;
export const COLUMN_DECIMAL_DIVISION_GENERATOR_REVISION = COLUMN_DECIMAL_DIVISION_CORE_CONTRACT.generator_revision;
...
export const DECIMAL_DIVISION_CURRICULUM_PATH = simpleCurriculumPath(DECIMAL_DIVISION_CORE_CONTRACT, 'jp-grade-5');
export const FRACTION_INTEGER_MULTIPLICATION_CURRICULUM_PATH = simpleCurriculumPath(FRACTION_INTEGER_MULTIPLICATION_CORE_CONTRACT, 'jp-grade-6');
export const FRACTION_INTEGER_DIVISION_CURRICULUM_PATH = simpleCurriculumPath(FRACTION_INTEGER_DIVISION_CORE_CONTRACT, 'jp-grade-6');
export const FRACTION_SUMMARY_IMPROPER_CURRICULUM_PATH = simpleCurriculumPath(FRACTION_SUMMARY_IMPROPER_CORE_CONTRACT, 'jp-grade-6');

function columnCurriculumPath(core: { curriculum_path: readonly string[]; skill_id: string }, gradeId: string): readonly CurriculumPathSegment[] {
  return [
    { id: 'root', label: core.curriculum_path[0]! },
    { id: gradeId, label: core.curriculum_path[1]! },
    { id: `${core.skill_id}:area`, label: core.curriculum_path[2]! },
    { id: core.skill_id, label: core.curriculum_path[3]! },
  ];
}
export const COLUMN_ADD_2DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_ADD_2DIGIT_CORE_CONTRACT, 'jp-grade-2');
export const COLUMN_SUBTRACT_2DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_SUBTRACT_2DIGIT_CORE_CONTRACT, 'jp-grade-2');
export const COLUMN_ADD_3_4DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_ADD_3_4DIGIT_CORE_CONTRACT, 'jp-grade-3');
export const COLUMN_SUBTRACT_3_4DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_SUBTRACT_3_4DIGIT_CORE_CONTRACT, 'jp-grade-3');
export const COLUMN_MULTIPLY_1DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_MULTIPLY_1DIGIT_CORE_CONTRACT, 'jp-grade-3');
export const COLUMN_MULTIPLY_2DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_MULTIPLY_2DIGIT_CORE_CONTRACT, 'jp-grade-3');
export const COLUMN_DIVIDE_1DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_DIVIDE_1DIGIT_CORE_CONTRACT, 'jp-grade-3');
export const COLUMN_DIVIDE_2DIGIT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_DIVIDE_2DIGIT_CORE_CONTRACT, 'jp-grade-4');
export const COLUMN_DECIMAL_ADD_SUBTRACT_CURRICULUM_PATH = columnCurriculumPath(COLUMN_DECIMAL_ADD_SUBTRACT_CORE_CONTRACT, 'jp-grade-4');
export const COLUMN_DECIMAL_MULTIPLY_INTEGER_CURRICULUM_PATH = columnCurriculumPath(COLUMN_DECIMAL_MULTIPLY_INTEGER_CORE_CONTRACT, 'jp-grade-4');
export const COLUMN_DECIMAL_DIVIDE_INTEGER_CURRICULUM_PATH = columnCurriculumPath(COLUMN_DECIMAL_DIVIDE_INTEGER_CORE_CONTRACT, 'jp-grade-4');
export const COLUMN_DECIMAL_MULTIPLICATION_CURRICULUM_PATH = columnCurriculumPath(COLUMN_DECIMAL_MULTIPLICATION_CORE_CONTRACT, 'jp-grade-5');
export const COLUMN_DECIMAL_DIVISION_CURRICULUM_PATH = columnCurriculumPath(COLUMN_DECIMAL_DIVISION_CORE_CONTRACT, 'jp-grade-5');
...
export const FRACTION_INTEGER_MULTIPLICATION_LAYOUT: WorksheetLayout = { ...FRACTION_INTEGER_MULTIPLICATION_CORE_CONTRACT.layout };
export const FRACTION_INTEGER_DIVISION_LAYOUT: WorksheetLayout = { ...FRACTION_INTEGER_DIVISION_CORE_CONTRACT.layout };
export const FRACTION_SUMMARY_IMPROPER_LAYOUT: WorksheetLayout = { ...FRACTION_SUMMARY_IMPROPER_CORE_CONTRACT.layout };
export const DECIMAL_DIVISION_LAYOUT: WorksheetLayout = { ...DECIMAL_DIVISION_CORE_CONTRACT.layout };
export const COLUMN_ADD_2DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_ADD_2DIGIT_CORE_CONTRACT.layout };
export const COLUMN_SUBTRACT_2DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_SUBTRACT_2DIGIT_CORE_CONTRACT.layout };
export const COLUMN_ADD_3_4DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_ADD_3_4DIGIT_CORE_CONTRACT.layout };
export const COLUMN_SUBTRACT_3_4DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_SUBTRACT_3_4DIGIT_CORE_CONTRACT.layout };
export const COLUMN_MULTIPLY_1DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_MULTIPLY_1DIGIT_CORE_CONTRACT.layout };
export const COLUMN_MULTIPLY_2DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_MULTIPLY_2DIGIT_CORE_CONTRACT.layout };
export const COLUMN_DIVIDE_1DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_DIVIDE_1DIGIT_CORE_CONTRACT.layout };
export const COLUMN_DIVIDE_2DIGIT_LAYOUT: WorksheetLayout = { ...COLUMN_DIVIDE_2DIGIT_CORE_CONTRACT.layout };
export const COLUMN_DECIMAL_ADD_SUBTRACT_LAYOUT: WorksheetLayout = { ...COLUMN_DECIMAL_ADD_SUBTRACT_CORE_CONTRACT.layout };
export const COLUMN_DECIMAL_MULTIPLY_INTEGER_LAYOUT: WorksheetLayout = { ...COLUMN_DECIMAL_MULTIPLY_INTEGER_CORE_CONTRACT.layout };
export const COLUMN_DECIMAL_DIVIDE_INTEGER_LAYOUT: WorksheetLayout = { ...COLUMN_DECIMAL_DIVIDE_INTEGER_CORE_CONTRACT.layout };
export const COLUMN_DECIMAL_MULTIPLICATION_LAYOUT: WorksheetLayout = { ...COLUMN_DECIMAL_MULTIPLICATION_CORE_CONTRACT.layout };
export const COLUMN_DECIMAL_DIVISION_LAYOUT: WorksheetLayout = { ...COLUMN_DECIMAL_DIVISION_CORE_CONTRACT.layout };

...
const RUBY_TEXT: Readonly<Record<string, readonly RubyPart[]>> = {
  ...
  '簡単な一次方程式': [["簡単", "かんたん"], 'な', ["一次方程式", "いちじほうていしき"]],
  '一次方程式(1)：基本形': [["一次方程式", "いちじほうていしき"], '(1)：', ["基本形", "きほんけい"]],
  '一次方程式(2)：括弧・整数係数中心': [["一次方程式", "いちじほうていしき"], '(2)：', ["括弧", "かっこ"], '・', ["整数係数", "せいすうけいすう"], ["中心", "ちゅうしん"]],
  '一次方程式(3)：括弧・分数・小数係数': [["一次方程式", "いちじほうていしき"], '(3)：', ["括弧", "かっこ"], '・', ["分数", "ぶんすう"], '・', ["小数係数", "しょうすうけいすう"]],
  '学年': [["学年", "がくねん"]],
  ...
  '連立方程式（加減法）': [["連立方程式", "れんりつほうていしき"], '（', ["加減法", "かげんほう"], '）'],
  '連立方程式（代入法）': [["連立方程式", "れんりつほうていしき"], '（', ["代入法", "だいにゅうほう"], '）'],
  '連立方程式（まとめ(1)）': [["連立方程式", "れんりつほうていしき"], '（まとめ(1)）'],
  '連立方程式（まとめ(2)）': [["連立方程式", "れんりつほうていしき"], '（まとめ(2)）'],
  '次の連立方程式を加減法で解きなさい。': ['次の', ["連立方程式", "れんりつほうていしき"], 'を', ["加減法", "かげんほう"], 'で', ["解", "と"], 'きなさい。'],
  '次の連立方程式を代入法で解きなさい。': ['次の', ["連立方程式", "れんりつほうていしき"], 'を', ["代入法", "だいにゅうほう"], 'で', ["解", "と"], 'きなさい。'],
  '次の連立方程式を適切な方法で解きなさい。': ['次の', ["連立方程式", "れんりつほうていしき"], 'を', ["適切", "てきせつ"], 'な', ["方法", "ほうほう"], 'で', ["解", "と"], 'きなさい。'],
  '式を整理し、次の連立方程式を適切な方法で解きなさい。': [["式", "しき"], 'を', ["整理", "せいり"], 'し、次の', ["連立方程式", "れんりつほうていしき"], 'を', ["適切", "てきせつ"], 'な', ["方法", "ほうほう"], 'で', ["解", "と"], 'きなさい。'],

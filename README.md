...
設計思想と現行文書の入口は[`docs/README.md`](docs/README.md)です。AIエージェントを含む実装者は、まず[`docs/principles.md`](docs/principles.md)を確認し、対象領域の[`docs/architecture/`](docs/architecture/)を参照してください。未解決事項はGitHub Issues（[`docs/issues.md`](docs/issues.md)から参照）、support scopeと将来計画は[`docs/roadmap.md`](docs/roadmap.md)で管理します。
